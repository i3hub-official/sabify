...
<style>
  ...
  /* ── Brand panel — intentionally always dark purple ── */
 ...
 .rp-logo-link { display:inline-block; line-height:0; transition:opacity .2s; }
  ...
  .fp-back-home:hover { border-color: var(--purple-primary); color: var(--purple-primary); background: var(--purple-light); transform: translateX(-2px); }
  ...
  .fp-welcome-msg :global(svg) { color: var(--purple-primary); flex-shrink: 0; }
  ...
  .fp-btn-back:hover { border-color: var(--purple-primary); color: var(--purple-primary); background: var(--purple-light); }
  ...
  .fp-success-email { display: inline-flex; align-items: center; gap: 0.5rem; background: var(--purple-light); border: 1px solid var(--border); border-radius: 0.625rem; padding: 0.5rem 0.875rem; font-size: 0.813rem; font-weight: 600; color: var(--purple-primary); }
